...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=28&pause=1000&color=00C2FF&center=true&vCenter=true&width=900&lines=Ketan+Ayatti;Full+Stack+Developer+%7C+DevOps+Engineer+Intern;Building+Reliable+%26+Scalable+Systems;Automating+Deployments+%7C+Shipping+Products" />

<br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,100:5D3FD3&height=120&section=header"/>
...
I don't just build applications — I take them all the way from first commit to a production-grade, containerized, automated deployment.
...
✅ Automated and containerized deployments  
✅ Self-healing, scalable infrastructure  
✅ Systems that recover — not just systems that run  
...
```
Development Foundations  →  Backend & Web Development (Node.js, Express, MongoDB)
Full Stack Products      →  React, Socket.io, JWT Auth, REST APIs
Containerization         →  Docker, Docker Compose, Multi-stage Builds
Infrastructure           →  Linux Server Deployments, NGINX Reverse Proxy
Automation               →  Jenkins CI/CD, GitHub Actions, Multi-branch Pipelines
...
<img src="https://skillicons.dev/icons?i=react,vite,tailwind,nodejs,express,mongodb,js"/>

**DevOps & Infrastructure**

<img src="https://skillicons.dev/icons?i=aws,docker,linux,jenkins,githubactions,git,bash,nginx"/>
...
Below are the systems I have built — each combining **full-stack product engineering with DevOps-grade deployment practices**.

---

### 🔒 Communiatec — DevOps-Driven Full Stack Communication Platform

A production-grade, full-stack communication platform that unifies **real-time messaging, collaborative coding, secure file sharing, and AI-assisted workflows** — deployed through an automated Jenkins CI/CD pipeline.
...
### 🤖 AI Mock Interview Platform — Multi-Environment DevOps Pipeline

An AI-powered mock interview platform with **resume-based personalization, adaptive questioning, and multi-model evaluation** — deployed through a branch-aware Jenkins CI/CD pipeline with Docker Compose.
...
- Branch-aware Jenkins pipeline: `develop` → staging, `main` → production
...
**Engineering Goal:** Design a resilient deployment platform capable of detecting application failures and automatically restoring service stability — without human intervention.
...
automation:          mandatory — eliminate manual drift
...
monitoring:          important — you can't fix what you can't observe
```
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:5D3FD3,100:0D1117&height=120&section=footer"/>
